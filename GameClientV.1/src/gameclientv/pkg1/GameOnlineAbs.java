...
public class GameOnlineAbs extends AnchorPane {
    ...
    public GameOnlineAbs(GameClientV1 client,Stage primaryStage) {
        ...
        Player1Score.setImage(new Image(getClass().getResource("taqwa.jpg").toExternalForm()));
        ...
        Player1Score0.setLayoutX(119.0);
